...
pub(crate) mod neon {
    use core::arch::aarch64::{
        uint32x4_t, vaddq_u32, vandq_u32, vdupq_n_u32, vdupq_n_f32, veorq_u32, vorrq_u32,
        vsetq_lane_u32, vsetq_lane_f32, vshlq_n_u32, vshrq_n_u32, vsubq_u32, vsubq_f32, vmovq_n_u32,
        vreinterpretq_f32_u32, vreinterpretq_u32_f32,
    };
    ...
    impl core::ops::Shl<i32> for Int8 {
        ...
        fn shl(self, other: i32) -> Int8 {
            Int8 {
                v: unsafe { vshlq_n_u32(self.v, other) },
            }
        }
    }
    ...
    impl core::ops::Shr<i32> for Int8 {
        ...
        fn shr(self, other: i32) -> Int8 {
            Int8 {
                v: unsafe { vshrq_n_u32(self.v, other) },
            }
        }
    }

    impl From<[u32; 4]> for Int8 {
        #[inline(always)]
    ...
    impl From<Int8> for [u32; 4] {
        #[inline(always)]
        fn from(i: Int8) -> [u32; 4] {
            unsafe { core::mem::transmute(i.v) }
        }
    }
    ...
    mod tests {
        ...
        #[test]
        fn shr() {
            let a = Int8::from([0xffffffff; 4]) >> 16;
            assert_eq!(a.get(0), 0x0000ffff);
            assert_eq!(a.get(1), 0x0000ffff);
            assert_eq!(a.get(2), 0x0000ffff);
            assert_eq!(a.get(3), 0x0000ffff);
        ...
        #[test]
        fn to_f32_norm() {
            let a = Int8::from([0x00000000; 4]);
            let b = Int8::from([0x80000000; 4]);
            let c = Int8::from([0xffffffff; 4]);
        ...
        fn reverse_bits() {
            ...
            assert_eq!(Int8::from([a; 4]).reverse_bits().get(0), a.reverse_bits());
            assert_eq!(Int8::from([b; 4]).reverse_bits().get(0), b.reverse_bits());
            assert_eq!(Int8::from([c; 4]).reverse_bits().get(0), c.reverse_bits());
            assert_eq!(Int8::from([d; 4]).reverse_bits().get(0), d.reverse_bits());
        }
    }
}
#[cfg(all(target_arch = "aarch64", feature = "simd"))]
